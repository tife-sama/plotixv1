...
export const CoachCTACardLG: React.FC = () => {
  const [date, setDate] = React.useState<Date>();

  return (
    <div className=" hidden md:block cursor-pointer w-[150px]">
      <Popover>
        <PopoverTrigger asChild>
          <Button
            className={cn(
              "  text-center font-normal mb-2 mt-3",
              !date && "text-white"
            )}
          >
